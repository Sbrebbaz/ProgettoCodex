...
public class PointPositionRequirementSide extends PlaceRequirementSide {
	...
	public PointPositionRequirementSide(List<Symbol> center, Corner[] corners, List<Symbol> placeRequirements, MapCard[][] positionRequirement) {
	...
	public PointPositionRequirementSide(List<Symbol> center, Corner cornerTopLeft, Corner cornerTopRight,
			Corner cornerBottomLeft, Corner cornerBottomRight, List<Symbol> placeRequirements, MapCard[][] positionRequirement) {
